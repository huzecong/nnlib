import builtins
from typing import Any, BinaryIO, Callable, ContextManager, Iterator, Optional, Sequence, Tuple, Type, TypeVar, Union, overload
...
def save(obj: Any, file: Union[str, BinaryIO]) -> None: ...


def load(file: Union[str, BinaryIO]) -> Any: ...
